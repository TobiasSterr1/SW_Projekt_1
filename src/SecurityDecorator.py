        ...
        if id_token:
            try:
                ...
                if claims is not None:
                    ...
                    person = adm.get_person_by_guid(guid=google_user_id)
                    if person is not None:
                        ...
                        nutzen zu können.
                        """
                        person = adm.create_person(benutzername="", email=email, google_user_id=google_user_id, haushalt_id=0, firstname=name.split(" ")[0], lastname=name.split(" ")[1])
